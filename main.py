...
if __name__ == "__main__":
    ...
    #print("Dealer:")
    #evaluate(list(env.return_queue))
    # Train and evaluate TD agent
    #env = get_env()
    #td_agent: AbstractAgent = TDAgent(env, number_of_episodes)
    #td_agent.train()
    #print("TD Agent:")
    #evaluate(list(env.return_queue))

    # Train and evaluate SARSA agent
    #env = get_env()
    sarsa_agent: AbstractAgent = SarsaAgent(env, number_of_episodes)
    sarsa_agent.train()
    print("\nSARSA Agent:")
    evaluate(list(env.return_queue))
